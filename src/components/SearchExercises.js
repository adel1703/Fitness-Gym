...
const SearchExercises = ({setExercises, bodyPart, setBodyPart}) => {
  ...
  return (
    ...
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px" color="#2e2f2f">
      ...
      <Button variant='contained' sx={{bgcolor:'#FFCC00', color:'white', textTransform:'none', width:{lg:'175px', xs:'80px'}, fontSize:{lg:'20px', xs:'14px'},height:'56px', position:"absolute", right:'0'}} onClick={handelSearch}>
        Search
        </Button>
      </Box>
